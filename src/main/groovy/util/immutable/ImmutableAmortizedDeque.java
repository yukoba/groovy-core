        ...
        switch (front.size()) {
            case 0:
                ...
                return new ImmutableAmortizedDeque<E>(
                        ImmutableCollections.<E>stack().plus(back.minusAt(0)).minusAt(0),
            ...
            case 1:
                ...
                return new ImmutableAmortizedDeque<E>(
                        ImmutableCollections.<E>stack().plus(back.minusAt(0)),
                        ImmutableCollections.<E>stack().plus(back.get(0)));

            default:
                // If there's more than one on front, we pop one off.
                return new ImmutableAmortizedDeque<E>(front.minusAt(0), back);
        }
    }
        ...
        switch (back.size()) {
            case 0:
                return new ImmutableAmortizedDeque<E>(
                        ...
                        ImmutableCollections.<E>stack().plus(front.minusAt(0)).minusAt(0));

            case 1:
                return new ImmutableAmortizedDeque<E>(
                        ImmutableCollections.<E>stack().plus(front.get(0)),
                        ImmutableCollections.<E>stack().plus(front.minusAt(0)));

            default:
                return new ImmutableAmortizedDeque<E>(front, back.minusAt(0));
